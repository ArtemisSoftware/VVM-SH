...
public class CarregarTrabalhoAsyncTask__v2 extends AsyncTask<Sessao, Void, Void> {
    ...
    public CarregarTrabalhoAsyncTask__v2(OnTransferenciaListener listener, VvmshBaseDados vvmshBaseDados, TransferenciasRepositorio repositorio, String idUtilizador){
