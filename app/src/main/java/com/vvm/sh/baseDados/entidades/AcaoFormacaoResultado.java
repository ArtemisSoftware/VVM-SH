...
@Entity(tableName = "acoesFormacaoResultado",
        ...
        foreignKeys = @ForeignKey(entity = AtividadePendente.class,
                ...
                onDelete = CASCADE))
public class AcaoFormacaoResultado {
    ...
    public AcaoFormacaoResultado(int idAtividade, int idDesignacao, @NonNull String local, @NonNull Date data, @NonNull Date inicio, @NonNull Date termino) {
