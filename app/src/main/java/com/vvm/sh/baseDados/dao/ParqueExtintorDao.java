...
abstract public class ParqueExtintorDao implements BaseDao<ParqueExtintorResultado> {
    ...
    @Transaction
    @Query("SELECT IFNULL(valido) as ct_valido " +
            "FROM parqueExtintores as prq_ext " +
    ...
    abstract public Observable<Integer> inserirValicao(int idTarefa);
    ...
    @Query("UPDATE parqueExtintoresResultado SET valido = 1 " +
            ...
            ")")
    abstract public Observable<Integer> atualizarValidacao(int idTarefa);
