...
public class RecarregarTipoAsyncTask__v2 extends TipoAsyncTask {

    private MensagensUtil dialogo;

    public RecarregarTipoAsyncTask__v2(Activity activity, VvmshBaseDados vvmshBaseDados, CarregamentoTiposRepositorio repositorio) {
