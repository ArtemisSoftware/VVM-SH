...
public class Sintaxe {
    ...
    public static final int SEM_REGISTO = -1;
    public static final String SEM_TEXTO = "";

    public static final String ID_UTILIZADOR_INEXISTENTE = "";
    ...
    public class Alertas{
        ...
        public static final String MARCAR_QUESTOES_NAO_IMPLEMENTADOS = "Marcar todas as questões como não implementados?";
    ...
    public class Frases{
        ...
        public static final String ENVIAR_FICHEIRO_FTP = "A enviar o ficheiro por ftp...";
    ...
    public class Email {
        ...
        public static final String TITULO_INFORMACAO_SST = "Segurança e Saúde do Trabalho | Obrigatoriedades legais";
    }
